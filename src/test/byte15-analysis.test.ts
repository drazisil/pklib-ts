...
describe('Byte 15 Bit Analysis', () => {
  test('Analyze the exact bit difference at byte 15', () => {
    const originalPath = '/data/Code/pklib/tests/testDataset/implode-decoder/binary.decomp';
    const expectedPath = '/data/Code/pklib/tests/testDataset/implode-decoder/binary.imploded';
